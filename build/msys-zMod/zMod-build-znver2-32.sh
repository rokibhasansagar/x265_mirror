...
export COMMON_OPTS="-Wno-deprecated -DENABLE_HDR10_PLUS=ON -DHIGH_BIT_DEPTH=ON -DENABLE_SHARED=OFF -DENABLE_CLI=ON -DENABLE_PIC=ON -DSTATIC_LINK_CRT=ON -DENABLE_VAPOURSYNTH=ON -DENABLE_AVISYNTH=ON -DCMAKE_ASM_NASM_FLAGS='-w-macro-params-legacy' -DCMAKE_TOOLCHAIN_FILE=${build_dir}/toolchain-i686-w64-mingw32.cmake"
...
export file_prefix="x265-x86-v${latest_tag}+${tag_distance}-zMod-gcc${gccver}"
