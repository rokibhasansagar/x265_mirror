...
export COMMON_OPTS="-Wno-deprecated -DENABLE_PIC=ON -DENABLE_HDR10_PLUS=ON -DENABLE_SHARED=OFF -DSTATIC_LINK_CRT=ON -DENABLE_VAPOURSYNTH=ON -DENABLE_AVISYNTH=ON -DCMAKE_ASM_NASM_FLAGS='-w-macro-params-legacy' -DCMAKE_TOOLCHAIN_FILE=${build_dir}/toolchain-x86_64-w64-mingw32.cmake"
